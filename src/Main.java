...
public class Main {
    public static void main (String [] args){
        ...
        FamilyRoom familyRoom = new FamilyRoom(null, 0, null);
        System.out.println(familyRoom.getRoomType());
        System.out.println(familyRoom.getNumRoom());
        for (Integer roomNum : familyRoom.getRoomNumSet()) {
            System.out.printf("%03d\n", roomNum);
        }
